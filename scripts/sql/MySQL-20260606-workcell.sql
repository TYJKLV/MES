...
-- ----------------------------
INSERT IGNORE INTO `sp_sys_menu` VALUES ('20', 'workcell', '加工单元管理', '#', '1', '2', 7, '0', 'user:add', 'fa fa-cubes', '', NOW(), 'admin', NOW(), 'admin');

-- ----------------------------
-- 菜单项：加工单元维护（三级：加工单元管理 > 加工单元维护）id=201
-- ----------------------------
INSERT IGNORE INTO `sp_sys_menu` VALUES ('201', 'workcellDef', '加工单元维护', '/basedata/workcell/list-ui', '20', '3', 1, '0', 'user:add', 'fa fa-cube', '', NOW(), 'admin', NOW(), 'admin');

-- ----------------------------
-- 角色-菜单绑定：管理员可访问加工单元管理
-- ----------------------------
INSERT IGNORE INTO `sp_sys_role_menu` VALUES ('1340000000000028', '1185025876737396738', '20', NOW(), 'admin', NOW(), 'admin');
INSERT IGNORE INTO `sp_sys_role_menu` VALUES ('1340000000000029', '1185025876737396738', '201', NOW(), 'admin', NOW(), 'admin');

-- ----------------------------
-- 测试数据：加工单元（先清理再插入，保证可重复执行）
-- ----------------------------
DELETE FROM `sp_workcell` WHERE `id` IN ('1360000000000001', '1360000000000002');
